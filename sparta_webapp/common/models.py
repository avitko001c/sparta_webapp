...
try:
    ...
    import json
from sparta_webapp.users.models import User 
import uuid
...
class Log(models.Model):
    server = models.ForeignKey('ServerInFor', on_delete=models.CASCADE, verbose_name=_('Server'))
...
class CommandLog(models.Model):
    log = models.ForeignKey('Log', on_delete=models.CASCADE, verbose_name=_('Log'))
...
#class Foo(models.Model):
    #company_type = models.ForeignKey('ContentType', on_delete=models.CASCADE)
